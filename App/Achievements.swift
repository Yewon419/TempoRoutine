...
enum AchievementID: String, CaseIterable, Codable {
    ...
    var caption: String {
        switch self {
        case .firstCheckIn: Loc.str("첫 컨디션 기록을 남겨요")
        case .checkIns10:   Loc.str("컨디션 기록 10일을 완성해요")
        case .checkIns50:   Loc.str("컨디션 기록 50일을 완성해요")
        case .checkIns100:  Loc.str("컨디션 기록 100일을 완성해요")
        case .checkIns365:  Loc.str("컨디션 기록 365일을 완성해요")
        ...
        case .nightOwl:     Loc.str("깊은 새벽에 컨디션을 기록했어요")
