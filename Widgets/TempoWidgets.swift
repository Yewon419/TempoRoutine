...
enum WInk {   // 위젯 타깃 내부 공용(Phase2Widgets가 함께 씀)
    ...
    // 계절 글로우 팔레트 — 앱 Ink.glow* 동값(2026-07-28 2차 파스텔 재조정)
    static let glowWinter = dyn((0x83, 0xAC, 0xDD), (0x9F, 0xBE, 0xE3))
    static let glowSpring = dyn((0xF2, 0xC7, 0x44), (0xEB, 0xD0, 0x68))
    static let glowSummer = dyn((0x7C, 0xC9, 0x6C), (0x93, 0xCD, 0x86))
    static let glowAutumn = dyn((0xEE, 0x9B, 0x55), (0xEF, 0xAF, 0x7C))
