...
struct WPalette {
    ...
    /// 모던 — 시안 SSOT §1.2(도트 그리드 + 무채 램프 + 다홍 시그널 + 로즈 관례색).
    /// ⚠ 2026-08-12부터 시스템 라이트/다크를 따라간다(앱 ThemePalette.modern 사본).
    /// 여름·가을 명도차: 다크는 여름을 올려서, 라이트는 가을을 내려서 벌린다.
    static let modern = WPalette(
        winter: dyn((0xC9, 0x43, 0x2C), (0xE0, 0x70, 0x5C)),
        spring: dyn((0x9E, 0xA4, 0xAE), (0xED, 0xEF, 0xF3)),
        summer: dyn((0x6F, 0x76, 0x81), (0xC2, 0xC8, 0xD2)),
        autumn: dyn((0x3D, 0x43, 0x4D), (0x7C, 0x81, 0x8C)),
        text: dyn((0x10, 0x10, 0x14), (0xE9, 0xE7, 0xF0)),
        paper: dyn((0xFA, 0xFA, 0xFC), (0x0A, 0x0A, 0x0C)),
        coral: dyn((0xC9, 0x43, 0x2C), (0xE0, 0x70, 0x5C)),
        record: dyn((0x5B, 0x62, 0x70), (0xA9, 0xAF, 0xC0)),
        predictGray: dyn((0x8A, 0x90, 0x99), (0xA9, 0xAF, 0xC0)),
        holidayRed: dyn((0xC2, 0x45, 0x6A), (0xEC, 0x8A, 0xA0)),
        saturday: flat((0x7F, 0xA4, 0xE8)),
        frost: dyn((0xF4, 0xF4, 0xF7), (0x06, 0x06, 0x07)),
        glowWinter: dyn((0xD4, 0x55, 0x3E), (0xE2, 0x5B, 0x45)),
        glowSpring: dyn((0xB4, 0xBA, 0xC4), (0xF5, 0xF6, 0xF8)),
        glowSummer: dyn((0x84, 0x8B, 0x96), (0xC6, 0xCC, 0xD6)),
